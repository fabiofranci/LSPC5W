...
//per ora lo saltiamo!
    ...
    //db = window.openDatabase("LASAETTAPC5WDB", "1.0.1", "Database La Saetta PC5W", 200000);
    db = window.sqlitePlugin.openDatabase("LASAETTAPC5WDB", "1.0.1", "Database La Saetta PC5W", 200000);
    try {
        db.transaction(function (tx) {
